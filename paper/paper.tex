...
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{../work/beam/fig_loc_svals_left.pdf}
  \caption{A really Awesome Image}\label{fig:awesome_image1}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{../work/beam/fig_loc_svals_inner.pdf}
  \caption{A really Awesome Image}\label{fig:awesome_image2}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{../work/beam/fig_loc_svals_right.pdf}
...
\begin{figure}[!htb]
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{../work/beam/fig_proj_error_left.pdf}
  \caption{A really Awesome Image}\label{fig:awesome_image1}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{../work/beam/fig_proj_error_inner.pdf}
  \caption{A really Awesome Image}\label{fig:awesome_image2}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{../work/beam/fig_proj_error_right.pdf}
  \caption{A really Awesome Image}\label{fig:awesome_image3}
\endminipage
\end{figure}
...
\begin{figure}[!htb]
    \includegraphics[width=\linewidth]{../work/beam/fig_loc_rom_error.pdf}
