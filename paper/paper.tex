...
Based on the example of a graded concrete slab, the methods for the construction of local approximation spaces described in~\cref{sec:Randomized range finder and POD,sec:Heuristic randomized range finder} are compared, the proposed reduced order model (ROM) is validated, and results for the solution of a shape optimization problem are presented.
